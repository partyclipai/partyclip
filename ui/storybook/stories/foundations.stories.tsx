    ...
    <div className="partyclip-story">
      <main className="partyclip-story__inner space-y-6">
        <section className="partyclip-story__frame p-6">
          <div className="partyclip-story__label">Foundations</div>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight">Primitives and interaction states</h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            A dense pass over the base controls that Partyclip pages use for operational actions, filtering,
        ...
        <Section eyebrow="Inputs" title="Form controls with real Partyclip copy">
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Foundation stories keep base shadcn/Radix primitives visible in every variant and key interaction state used by Partyclip.",
      },
    },
  },
