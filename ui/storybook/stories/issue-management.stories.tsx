        ...
        <main className="partyclip-story__inner space-y-6">
          <section className="partyclip-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="partyclip-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="partyclip-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="partyclip-story">
        <main className="partyclip-story__inner space-y-6">
          <section className="partyclip-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="partyclip-story__label">IssueRunLedger</div>
