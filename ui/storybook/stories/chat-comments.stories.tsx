...
import type { Agent, FeedbackVote, IssueComment } from "@partyclipai/shared";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Partyclip work: checkout, comments, linked runs, and review feedback.",
      ...
      <main className="partyclip-story__inner space-y-6">
        <section className="partyclip-story__frame p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Partyclip operational content with mixed authors, system timeline events,
