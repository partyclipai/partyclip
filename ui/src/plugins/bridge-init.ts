 ...
 *
 * This is placed on `globalThis.__partyclipPluginBridge__` and consumed by
...
declare global {
  ...
  var __partyclipPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__partyclipPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__partyclipPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
