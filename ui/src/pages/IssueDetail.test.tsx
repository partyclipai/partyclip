...
import type { Agent, Issue, IssueTreeControlPreview, IssueTreeHold } from "@partyclipai/shared";
...
vi.mock("../context/CompanyContext", () => ({
  useCompany: () => ({
    companies: [{ id: "company-1", name: "Partyclip", issuePrefix: "PAP", status: "active" }],
    selectedCompanyId: "company-1",
    selectedCompany: { id: "company-1", name: "Partyclip", issuePrefix: "PAP", status: "active" },
