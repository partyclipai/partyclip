...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@partyclipai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Partyclip file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Partyclip storage.";
