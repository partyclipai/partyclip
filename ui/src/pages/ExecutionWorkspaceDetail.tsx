...
import type { ExecutionWorkspace, Issue, Project, ProjectWorkspace, RoutineListItem } from "@partyclipai/shared";
...
function ExecutionWorkspaceIssuesList({
  ...
  return (
    <IssuesList
      ...
      viewStateKey="partyclip:execution-workspace-issues-view"
  ...
  const runRoutine = useMutation({
    ...
    onSuccess: async (_, { id }) => {
      ...
      pushToast({
        ...
        body: "Partyclip created a run using this execution workspace.",
        tone: "success",
      });
    },
    onSettled: () => {
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Partyclip could not start the routine run.",
        tone: "error",
      });
    },
  });
...
export function ExecutionWorkspaceDetail() {
  ...
  if (workspaceId && activeTab === null) {
    ...
    try {
      const storedTab = localStorage.getItem(`partyclip:execution-workspace-tab:${workspaceId}`);
      if (
        storedTab === "issues" ||
        storedTab === "routines" ||
  ...
  const handleTabChange = (tab: ExecutionWorkspaceTab) => {
    try {
      localStorage.setItem(`partyclip:execution-workspace-tab:${workspace.id}`, tab);
    } catch {}
      ...
      <div className="space-y-4 overflow-hidden sm:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Configure the concrete runtime workspace that Partyclip reuses for this issue flow.
            ...
            <Card className="rounded-none">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Field label="Provision command" hint="Runs when Partyclip prepares this execution workspace">
                    <Textarea
