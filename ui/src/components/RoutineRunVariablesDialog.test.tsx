...
import type { Agent, ExecutionWorkspace, Project } from "@partyclipai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/partyclip/project-1",
      effectiveLocalFolder: "/tmp/partyclip/project-1",
