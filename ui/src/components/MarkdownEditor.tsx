...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@partyclipai/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative partyclip-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("partyclip-mdxeditor", !bordered && "partyclip-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "partyclip-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
