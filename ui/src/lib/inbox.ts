...
export const DISMISSED_KEY = "partyclip:inbox:dismissed";
export const READ_ITEMS_KEY = "partyclip:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "partyclip:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "partyclip:inbox:issue-columns";
export const INBOX_NESTING_KEY = "partyclip:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "partyclip:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "partyclip:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "partyclip:inbox:collapsed-groups";
