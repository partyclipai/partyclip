...
import { companySecrets, companySecretVersions } from "@partyclipai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@partyclipai/shared";
import { envBindingSchema } from "@partyclipai/shared";
