...
import { trackRoutineRun } from "@partyclipai/shared/telemetry";
  ...
  return {
    ...
    createTrigger: async (
      ...
      if (input.kind === "webhook") {
        ...
        secretMaterial = {
          webhookUrl: `${process.env.PARTYCLIP_API_URL}/api/routine-triggers/public/${publicId}/fire`,
    ...
    rotateTriggerSecret: async (
      ...
      return {
        ...
        secretMaterial: {
          webhookUrl: `${process.env.PARTYCLIP_API_URL}/api/routine-triggers/public/${existing.publicId}/fire`,
    ...
    firePublicTrigger: async (publicId: string, input: {
      ...
      if (trigger.signingMode === "none") {
        ...
        // generic X-Partyclip-Signature header so operators can use github_hmac
