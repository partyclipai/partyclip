...
function discoverWorkspacePackagePaths(rootDir: string): Map<string, string> {
  ...
  const ignoredDirNames = new Set([".git", ".partyclip", "dist", "node_modules"]);
...
function buildWorkspaceCommandEnv(input: {
  ...
  env.PARTYCLIP_WORKSPACE_CWD = input.worktreePath;
  env.PARTYCLIP_WORKSPACE_PATH = input.worktreePath;
  env.PARTYCLIP_WORKSPACE_WORKTREE_PATH = input.worktreePath;
  env.PARTYCLIP_WORKSPACE_BRANCH = input.branchName;
  env.PARTYCLIP_WORKSPACE_BASE_CWD = input.base.baseCwd;
  env.PARTYCLIP_WORKSPACE_REPO_ROOT = input.repoRoot;
  env.PARTYCLIP_WORKSPACE_SOURCE = input.base.source;
  env.PARTYCLIP_WORKSPACE_REPO_REF = input.base.repoRef ?? "";
  env.PARTYCLIP_WORKSPACE_REPO_URL = input.base.repoUrl ?? "";
  env.PARTYCLIP_WORKSPACE_CREATED = input.created ? "true" : "false";
  env.PARTYCLIP_PROJECT_ID = input.base.projectId ?? "";
  env.PARTYCLIP_PROJECT_WORKSPACE_ID = input.base.workspaceId ?? "";
  env.PARTYCLIP_AGENT_ID = input.agent.id ?? "";
  env.PARTYCLIP_AGENT_NAME = input.agent.name;
  env.PARTYCLIP_COMPANY_ID = input.agent.companyId;
  env.PARTYCLIP_ISSUE_ID = input.issue?.id ?? "";
  env.PARTYCLIP_ISSUE_IDENTIFIER = input.issue?.identifier ?? "";
  env.PARTYCLIP_ISSUE_TITLE = input.issue?.title ?? "";
  return env;
}
...
function buildExecutionWorkspaceCleanupEnv(input: {
  ...
  env.PARTYCLIP_WORKSPACE_CWD = input.workspace.cwd ?? "";
  env.PARTYCLIP_WORKSPACE_PATH = input.workspace.cwd ?? "";
  env.PARTYCLIP_WORKSPACE_WORKTREE_PATH =
    input.workspace.providerRef ?? input.workspace.cwd ?? "";
  env.PARTYCLIP_WORKSPACE_BRANCH = input.workspace.branchName ?? "";
  env.PARTYCLIP_WORKSPACE_BASE_CWD = input.projectWorkspaceCwd ?? "";
  env.PARTYCLIP_WORKSPACE_REPO_ROOT = input.projectWorkspaceCwd ?? "";
  env.PARTYCLIP_WORKSPACE_REPO_URL = input.workspace.repoUrl ?? "";
  env.PARTYCLIP_WORKSPACE_REPO_REF = input.workspace.baseRef ?? "";
  env.PARTYCLIP_PROJECT_ID = input.workspace.projectId ?? "";
  env.PARTYCLIP_PROJECT_WORKSPACE_ID = input.workspace.projectWorkspaceId ?? "";
  env.PARTYCLIP_ISSUE_ID = input.workspace.sourceIssueId ?? "";
  return env;
}
...
export async function realizeExecutionWorkspace(input: {
  ...
  const worktreeParentDir = configuredParentDir
    ...
    : path.join(repoRoot, ".partyclip", "worktrees");
