...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@partyclipai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: PartyclipPluginManifestV1, pluginDbId?: string): void;
