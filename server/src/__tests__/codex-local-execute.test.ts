...
import { execute } from "@partyclipai/adapter-codex-local/server";
...
describe("codex execute", () => {
  it("uses a Paperclip-managed CODEX_HOME outside worktree mode while preserving shared auth and config", async () => {
    ...
    try {
      ...
      if (previousPaperclipInWorktree === undefined) delete process.env.PARTYCLIP_IN_WORKTREE;
      else process.env.PARTYCLIP_IN_WORKTREE = previousPaperclipInWorktree;
