...
import type { ToolRunContext } from "@partyclipai/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@partyclipai/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<PartyclipPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<PartyclipPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @partyclip/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@partyclipai/plugin-hello-world-example",
    pluginKey: "partyclip.hello-world-example",
  ...
  {
    packageName: "@partyclipai/plugin-file-browser-example",
    pluginKey: "partyclip-file-browser-example",
  ...
  {
    packageName: "@partyclipai/plugin-kitchen-sink-example",
    pluginKey: "partyclip-kitchen-sink-example",
  ...
  {
    packageName: "@partyclipai/plugin-orchestration-smoke-example",
    pluginKey: "partyclipai.plugin-orchestration-smoke-example",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "partyclip.claude-usage",
