...
import * as serverUtils from "@partyclipai/adapter-utils/server-utils";
export type { RunProcessResult } from "@partyclipai/adapter-utils/server-utils";
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "PARTYCLIP_RESOLVED_COMMAND"] =
