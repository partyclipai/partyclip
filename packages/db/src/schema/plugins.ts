...
import type { PluginCategory, PluginStatus, PartyclipPluginManifestV1 } from "@partyclipai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<PartyclipPluginManifestV1>().notNull(),
