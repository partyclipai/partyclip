...
async function getIssueWorkspaceRuntime(client: PartyclipApiClient, issueId: string) {
...
export function createToolDefinitions(client: PartyclipApiClient): ToolDefinition[] {
  return [
    makeTool(
      "partyclipMe",
