...
```bash
pnpm --filter @partyclipai/server test:run -- openclaw-gateway
pnpm --filter @partyclipai/server typecheck
pnpm --filter @partyclipai/ui typecheck
pnpm --filter partyclipai typecheck
```
