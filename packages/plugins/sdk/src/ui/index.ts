/**
 * `@partyclipai/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@partyclipai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@partyclipai/plugin-sdk/ui";
 *
