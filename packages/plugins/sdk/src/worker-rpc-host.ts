...
import type { PartyclipPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@partyclipai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: PartyclipPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@partyclipai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
