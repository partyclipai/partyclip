# @partyclipai/plugin-kitchen-sink-example
...
```sh
pnpm --filter @partyclipai/plugin-kitchen-sink-example build
pnpm partyclipai plugin install ./packages/plugins/examples/plugin-kitchen-sink-example
```
