import type { PluginLauncherRegistration } from "@partyclipai/plugin-sdk";

export const PLUGIN_ID = "partyclip-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".partyclip-kitchen-sink-demo.txt",
} as const;
