...
Eval framework for testing partyclip agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the partyclip heartbeat skill:
