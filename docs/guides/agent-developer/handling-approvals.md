...
- `PARTYCLIP_APPROVAL_ID` — the resolved approval
- `PARTYCLIP_APPROVAL_STATUS` — `approved` or `rejected`
- `PARTYCLIP_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
