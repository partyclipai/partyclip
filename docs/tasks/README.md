...
|---|---|---|---|---|---|
| [L4-A](./L4-A-agent-invocation-wiring.md) | Wire pipeline executor to agent runner + live model adapter | blocked | `feature/agent-invocation-wiring` | Phase 1 | L4-E, X-3 |
| [L4-E](./L4-E-content-load-agent-config.md) | Content-load — ingest agent roster, personas, constitution, pipelines into the DB | in_progress | `feature/content-load-agent-config` | Phase 1 | ADR-005 |
