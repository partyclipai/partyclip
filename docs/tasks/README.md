...
|---|---|---|---|---|---|
| [L4-A](./L4-A-agent-invocation-wiring.md) | Wire pipeline executor to agent runner + live model adapter | in_progress | `feature/agent-invocation-wiring` | Phase 1 | L4-E |
| [L4-E](./L4-E-content-load-agent-config.md) | Content-load — ingest agent roster, personas, constitution, pipelines into the DB | done | `feature/content-load-agent-config` | Phase 1 | ADR-005 |
