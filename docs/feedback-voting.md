...
```bash
pnpm partyclipai feedback report
```
...
```bash
# Installed CLI
partyclipai feedback report

# Point to a different server or company
pnpm partyclipai feedback report --api-base http://127.0.0.1:3000 --company-id <company-id>

# Include raw payload dumps in the report
pnpm partyclipai feedback report --payloads
```
...
```bash
pnpm partyclipai feedback export
```
...
pnpm partyclipai feedback export --api-base http://127.0.0.1:3000 --company-id <company-id> --out ./my-export
```
