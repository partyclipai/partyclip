...
1. Creates `~/.partyclip/instances/default/db/` for storage
2. Ensures the `partyclip` database exists
3. Runs migrations automatically
4. Starts serving requests

Data persists across restarts. To reset: `rm -rf ~/.partyclip/instances/default/db`.
