...
```sh
pnpm partyclipai allowed-hostname my-macbook.tailnet.ts.net
```
...
- Login or redirect errors on a private hostname: add it with `partyclipai allowed-hostname`.
