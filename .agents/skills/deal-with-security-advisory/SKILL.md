...
```
gh api repos/partyclipai/partyclip/security-advisories/{{ghsaId}}
...
```
gh api --method POST \
  repos/partyclipai/partyclip/security-advisories/{{ghsaId}}/forks
...
```
gh api --method POST \
  repos/partyclipai/partyclip/security-advisories/{{ghsaId}}/cve
...
```
gh api repos/partyclipai/partyclip/security-advisories/{{ghsaId}} --jq '.credits'
...
```
gh api --method PATCH \
  repos/partyclipai/partyclip/security-advisories/{{ghsaId}} \
  --input - << 'EOF'
{
  "credits": [
    {
...
### Advisory
https://github.com/partyclipai/partyclip/security/advisories/{{ghsaId}}
...
gh release view v{{patchedVersion}} --repo partyclipai/partyclip
...
* The published advisory URL: `https://github.com/partyclipai/partyclip/security/advisories/{{ghsaId}}`
* The release URL
